...
savefile = _DELTA_DIR / "assets/test_models/test_train_mothermachine_rois.hdf5"
epochs = 3
steps_per_epoch = 30
patience = 50
...
# Files
training_set_delta = config.training_set_path("rois")  # '/home/hslab/.cache/delta/training_sets/mothermachine/training/chambers_seg_set/train'
