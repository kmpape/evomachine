...
class UVTestingStrategyv3(AbstractStrategy):
    """
    ...
    """
    def __init__(self, cfg: ConfigImageProcessor):
        super().__init__(cfg=cfg)
        self.path_to_save = Path("/media/hslab/Data/ImageData/Idris/2024-05-10")
        ...
        self.proj_times = {i: val for i, val in enumerate([1, 2, 3, 5, 10, 30, 60, 60])}  # in seconds
        self.proj_brightness = {i: val for i, val in enumerate([1, 15, 29, 15, 15, 15, 15, 15])}  # brightness in (0,29]
